...
def student_dashboard():
    ...
    with st.spinner('Loading you enrolled subjects...'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border= True):
            ...
            new_name = st.text_input("Enter your name", placeholder='eg. Mr.Buttercup')
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like I am present, My name is watermelon.')
            except Exception:
